...
Promise.all([
  ...
  function getPlayerMilestones(a) {
    ...
    if (allAfter.apps === 0) groups.appearance.push("Final Appearance");
    if (currentIsCompetitive && compAfter.apps === 0) groups.appearance.push("Final Competitive Appearance");
